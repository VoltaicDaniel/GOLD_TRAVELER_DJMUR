...
class Enemigos(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imagenEnemigo = pygame.transform.scale(self.imagenEnemigo,(75,75))
...
class Tierra(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect_piso.centerx = 300
        self.rect_piso.centery = 290
    ...
    def dibujar(self,superficie):
        superficie.blit(self.piso,self.rect_piso)
...
def goldTraver():
    ...
    while True:
       ...
       # pygame.display.update()
        ...
        print(piso.rect_piso.centery)
        print(player.rect.centery)



        if player.rect.y == piso.rect_piso.centery:
            print("colisiono")
            player.rect.centery -=100
        if player.rect.y != piso.rect_piso.centery:
            #print("no ha colisionado")
            pass
